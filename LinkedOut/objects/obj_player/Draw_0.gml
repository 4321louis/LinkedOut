...
var colour_dist = min(dist,700)
draw_line_width_color(x,y,boss.x,boss.y,5,(c_red*(colour_dist/700)+c_yellow*(1-colour_dist/700)),(c_red*(colour_dist/700)+c_yellow*(1-colour_dist/700)));
